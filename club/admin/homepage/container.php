...
function postEvent() {
	...
	document.getElementById('picture_preview').innerHTML = '<div class="loadbar"><img src="../../img/loading_gif.gif" width="30px" height="30px" border-left="0" /></div>';
	upload_field.form.action = 'event.php';
	...
	xmlhttp.onreadystatechange = function() {
 	...
 	var url="event.php?event="+ev_bx+"&ev_head="+ev_head+"&venue="+
...
$('#post_event').on('click', function() {
    ...
    alert(form_data);                             
    $.ajax({
                url: 'event.php', // point to server-side PHP script 
...
<div class="event_wrap">
	<form enctype="multipart/form-data" method="POST" name="event-form"><br><br>
		<h3>Events :</h3>
		<p id="ev_msg"></p>
		<div class="event">
			<label>Select Image : </label>
			<iframe name="upload_iframe" id="upload_iframe" style="display:none; size: 100px 100px;"></iframe>
			<!-- iframe used for ajax file upload-->
...
?>
		...
		<input type="button" id="post_event" name="post_event" value="Post Event" onclick="postEvent();">
	</form>
</div>
<br>
		<hr width="500px">
...
?>
	...
	<style type="text/css">
		...
		.loadbar img[data-position] {
		  position: absolute;
		  border: 1px dotted red;
		}
		.loadbar img[data-position*=top]    { top: 0;    }
		.loadbar img[data-position*=bottom] { bottom: 0; }
		.loadbar img[data-position*=left]   { left: 0;   }
		.loadbar img[data-position*=right]  { right: 0;  }
		}
