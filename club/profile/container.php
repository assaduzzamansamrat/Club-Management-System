...
<form action="deactive.php" method="POST" enctype="multipart/form-data">
		<fieldset>
			<legend><?php echo $full_name ?></legend>
			...
			<table>
				<tr>
					...
					<td>
						...
						<div class="profile_1">
									<?php 
									echo'<img style="height:180px; width:146px; ;display: block; border:5px solid rgba(51, 51, 51, 0.8); margin-left: 2%;" src="../profile_images\\'.$avatar.'" alt="profile image" />';			 
							?>
		...
		<td>
				...
				<table>
					...
					<tr>
						...
						<td class="info"><p><?php echo $clubname ?></p></td>
						<td><span></span></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="info"><p id="jsptag"><?php echo $semester ?></p>
					...
					<tr>
						...
						<td><input  class="btn" type="button" value="Update Profile" onclick="updateProfile()"
							></td>
